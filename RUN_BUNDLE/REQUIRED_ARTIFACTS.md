# ATMOS REQUIRED ARTIFACTS (Canonical V1)
...
ATMOS is a TRUTH_ENGINE. It emits atmospheric domain truth only (including wind speed, rain rate, snow rate if modeled).
...
ATMOS output MUST NOT include:
- forecast guarantees or operational directives (vertical lens only)
